...
class SearchScreenAnoboyResult extends StatelessWidget {
  final AnoboyListModel anoboyResult;
  const SearchScreenAnoboyResult({super.key, required this.anoboyResult});
  ...
  Widget build(BuildContext context) {
    return NotificationListener<ScrollNotification>(
      ...
      child: ListView.builder(
        itemCount: anoboyResult.data.length,
        itemBuilder: (BuildContext context, int index) {
          final item = anoboyResult.data[index];
          return Padding(
