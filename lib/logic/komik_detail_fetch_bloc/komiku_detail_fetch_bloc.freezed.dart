...
$KomikuDetailFetchEventCopyWith<KomikuDetailFetchEvent> get copyWith => _$KomikuDetailFetchEventCopyWithImpl<KomikuDetailFetchEvent>(this as KomikuDetailFetchEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is KomikuDetailFetchEvent&&(identical(other.provider, provider) || other.provider == provider));
}
...
@override
String toString() {
  return 'KomikuDetailFetchEvent(provider: $provider)';
}
...
/// @nodoc
abstract mixin class $KomikuDetailFetchEventCopyWith<$Res>  {
  factory $KomikuDetailFetchEventCopyWith(KomikuDetailFetchEvent value, $Res Function(KomikuDetailFetchEvent) _then) = _$KomikuDetailFetchEventCopyWithImpl;
@useResult
$Res call({
...
class _$KomikuDetailFetchEventCopyWithImpl<$Res>
  ...
  _$KomikuDetailFetchEventCopyWithImpl(this._self, this._then);

  final KomikuDetailFetchEvent _self;
  final $Res Function(KomikuDetailFetchEvent) _then;
...
/// Adds pattern-matching-related methods to [KomikuDetailFetchEvent].
extension KomikuDetailFetchEventPatterns on KomikuDetailFetchEvent {
...
class _Started implements KomikuDetailFetchEvent {
...
@override
String toString() {
  return 'KomikuDetailFetchEvent.started(param: $param, provider: $provider)';
}
...
/// @nodoc
abstract mixin class _$StartedCopyWith<$Res> implements $KomikuDetailFetchEventCopyWith<$Res> {
...
class _Read implements KomikuDetailFetchEvent {
...
@override
String toString() {
  return 'KomikuDetailFetchEvent.read(item: $item, provider: $provider)';
}
...
/// @nodoc
abstract mixin class _$ReadCopyWith<$Res> implements $KomikuDetailFetchEventCopyWith<$Res> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is KomikuDetailFetchState);
}
...
/// @nodoc
class $KomikuDetailFetchStateCopyWith<$Res>  {
$KomikuDetailFetchStateCopyWith(KomikuDetailFetchState _, $Res Function(KomikuDetailFetchState) __);
}


/// Adds pattern-matching-related methods to [KomikuDetailFetchState].
extension KomikuDetailFetchStatePatterns on KomikuDetailFetchState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements KomikuDetailFetchState {
  const _Initial();
...
class _Loading implements KomikuDetailFetchState {
  const _Loading();
...
class _Completed implements KomikuDetailFetchState {
...
/// @nodoc
abstract mixin class _$CompletedCopyWith<$Res> implements $KomikuDetailFetchStateCopyWith<$Res> {
