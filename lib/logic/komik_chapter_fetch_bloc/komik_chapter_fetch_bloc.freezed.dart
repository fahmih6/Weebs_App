...
/// @nodoc
mixin _$KomikChapterFetchEvent {

 String get param; MangaProvider get provider;
/// Create a copy of KomikChapterFetchEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$KomikChapterFetchEventCopyWith<KomikChapterFetchEvent> get copyWith => _$KomikChapterFetchEventCopyWithImpl<KomikChapterFetchEvent>(this as KomikChapterFetchEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is KomikChapterFetchEvent&&(identical(other.param, param) || other.param == param)&&(identical(other.provider, provider) || other.provider == provider));
}
...
@override
String toString() {
  return 'KomikChapterFetchEvent(param: $param, provider: $provider)';
}
...
/// @nodoc
abstract mixin class $KomikChapterFetchEventCopyWith<$Res>  {
  factory $KomikChapterFetchEventCopyWith(KomikChapterFetchEvent value, $Res Function(KomikChapterFetchEvent) _then) = _$KomikChapterFetchEventCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$KomikChapterFetchEventCopyWithImpl<$Res>
    implements $KomikChapterFetchEventCopyWith<$Res> {
  _$KomikChapterFetchEventCopyWithImpl(this._self, this._then);

  final KomikChapterFetchEvent _self;
  final $Res Function(KomikChapterFetchEvent) _then;
...
/// Adds pattern-matching-related methods to [KomikChapterFetchEvent].
extension KomikChapterFetchEventPatterns on KomikChapterFetchEvent {
...
class _Started implements KomikChapterFetchEvent {
...
@override
String toString() {
  return 'KomikChapterFetchEvent.started(param: $param, provider: $provider)';
}
...
/// @nodoc
abstract mixin class _$StartedCopyWith<$Res> implements $KomikChapterFetchEventCopyWith<$Res> {
...
/// @nodoc
mixin _$KomikChapterFetchState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is KomikChapterFetchState);
}
...
/// @nodoc
class $KomikChapterFetchStateCopyWith<$Res>  {
$KomikChapterFetchStateCopyWith(KomikChapterFetchState _, $Res Function(KomikChapterFetchState) __);
}


/// Adds pattern-matching-related methods to [KomikChapterFetchState].
extension KomikChapterFetchStatePatterns on KomikChapterFetchState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements KomikChapterFetchState {
  const _Initial();
...
@override
String toString() {
  return 'KomikChapterFetchState.initial()';
}
...
class _Loading implements KomikChapterFetchState {
  const _Loading();
...
@override
String toString() {
  return 'KomikChapterFetchState.loading()';
}
...
class _Completed implements KomikChapterFetchState {
...
/// Create a copy of KomikChapterFetchState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
...
@override
String toString() {
  return 'KomikChapterFetchState.completed(isLoadMore: $isLoadMore, errorMessage: $errorMessage, chapterData: $chapterData)';
}
...
/// @nodoc
abstract mixin class _$CompletedCopyWith<$Res> implements $KomikChapterFetchStateCopyWith<$Res> {
